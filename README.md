...
Implemented: Gemini image analysis, staged analysis progress, modal detection review, editable names/categories/tags/descriptions/estimated values, remove/restore before saving, cropped Blob thumbnails, IndexedDB persistence, search, sorting, category filtering, tag filtering, grid/list views, and inventory statistics.

Planned: item detail editing and deletion, PDF export, manual object addition, richer image interaction, and duplicate-upload detection.