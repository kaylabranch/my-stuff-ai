...
export function InventorySection({ items, visibleItems, filters, tags, view, isLoading, error, onFilterChange, onViewChange, onEdit, onDelete }: InventorySectionProps) {
    return (
