...
interface ItemEditModalProps {
    ...
    isSaving: boolean;
    onSave: (
        changes: Pick<InventoryItem, 'name' | 'category' | 'description' | 'tags' | 'room' | 'estimatedValue'>,
    ) => void;
    onClose: () => void;
}
                ...
                <form className="edit-form" onSubmit={handleSubmit}>
                    ...
                    <label>
                        ...
                        <input
                            ...
                            list="edit-room-options"
                        />
                        <datalist id="edit-room-options">
                            {rooms.map((room) => (
                    ...
                    <label>
                        Tags
                        <input name="tags" defaultValue={item.tags.join(', ')} placeholder="tags, comma separated" />
                    </label>
                    <label>
                        Estimated value ($)
                        <input
                    ...
                    <div className="edit-actions">
                        ...
                        <button className="upload-button" type="submit" disabled={isSaving} title="Save changes">
