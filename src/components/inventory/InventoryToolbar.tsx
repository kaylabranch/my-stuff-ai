    ...
    return (
        <>
            <div className="toolbar">
                ...
                <select
                    value={filters.sort}
                    onChange={(event) => onFilterChange('sort', event.target.value as InventoryFilters['sort'])}
                    aria-label="Sort inventory"
                >
                    <option value="az">Name A-Z</option>
                    <option value="za">Name Z-A</option>
                    <option value="value-hi">Value high to low</option>
                    <option value="value-lo">Value low to high</option>
                </select>
                <select
                    value={filters.category}
                    onChange={(event) => onFilterChange('category', event.target.value as InventoryFilters['category'])}
                ...
                <select
                    value={filters.room}
                    onChange={(event) => onFilterChange('room', event.target.value)}
